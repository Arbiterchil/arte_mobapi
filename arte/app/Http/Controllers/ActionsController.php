...
class ActionsController extends Controller
{
    ...
    public function longComplexity(Request $request){
        $complexLong = new ActionsUser();
        return $complexLong->longComplexProcess($request);
    }

    public function search(Request $request){
        $pagination = new ActionsUser();
        return $pagination->searchwithpage($request);
    }
}
